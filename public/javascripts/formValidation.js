...
var skillReq = document.getElementById('skillReq1');
...
if(skillReq1) {
	skillReq1.onblur = checkSkillReq;
}
...
function checkSkillReq() {
	var error = document.getElementById('skillReqError');
	if(skillReq.value === 'N/A') {
		error.style.color = '#e69b22';
		return false;
	} else {
		error.style.color = 'rgb(35, 35, 35)';
